  ...
  return (
    <div className="content-section">
      ...
      {/* Title + Timer */}
            ...
            {/* Roommates + Submit */}
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginTop: 60 }}>
                ...
                <div style={{ marginBottom: 30 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 15 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
                      <label style={{ fontWeight: 500, fontSize: 16, minWidth: 70, color: '#333' }}>1st Roommate</label>
                      <input
                        type="text"
                        value={rm1}
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
                      <label style={{ fontWeight: 500, fontSize: 16, minWidth: 70, color: '#333' }}>2nd Roommate</label>
                      <input
                        type="text"
                        value={rm2}
