  ...
  return (
    <div className="content-section">
      ...
      {/* Your Batch */}
            ...
            {/* Current Batch */}
            <h3 style={{ marginTop: 20, marginBottom: 12, fontSize: 15, color: '#333', fontWeight: 600 }}>Current Batch:</h3>
            ...
            {/* Upcoming Batch */}
            <h3 style={{ marginTop: 20, marginBottom: 12, fontSize: 15, color: '#333', fontWeight: 600 }}>Upcoming NEXT Batch:</h3>
            <div className="batch-info-card" style={{ marginBottom: 24 }}>
              <table className="batch-table">
                <thead><tr><th>BATCH</th><th>TIME SLOT</th><th>RANGE</th></tr></thead>
            ...
            {/* Stats */}
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, fontSize: 14, color: '#000', fontWeight: 400, flexWrap: 'wrap' }}>
              <div style={{ background: '#fff', border: '1px solid #ddd', padding: 16, borderRadius: 10, flex: '1 1 250px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
                <div style={{ marginBottom: 10 }}><span style={{ fontWeight: 600 }}>Total students :</span> 650</div>
                <div style={{ marginBottom: 10 }}><span style={{ fontWeight: 600 }}>Alloted :</span> 487</div>
